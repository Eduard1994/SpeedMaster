...
//        barPlot.barLineColor = UICoxlor.colorFromHex(hexString: "#777777")
//        barPlot.barColor = UIColor.colorFromHex(hexString: "#555555")
        ...
        referenceLines.referenceLineLabelFont = UIFont.boldSystemFont(ofSize: 8)
        referenceLines.referenceLineColor = .mainYellow
        referenceLines.referenceLineLabelColor = .mainWhite
        
//        referenceLines.dataPointLabelColor = UIColor.white.withAlphaComponent(0.5)
        referenceLines.dataPointLabelColor = .mainYellow
