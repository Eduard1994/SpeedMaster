...
class Examples: ScrollableGraphViewDataSource {
    ...
    func createBarGraph(_ frame: CGRect) -> ScrollableGraphView {
        ...
        barPlot.shouldRoundBarCorners = false
        barPlot.barWidth = 15
        barPlot.barLineWidth = 5
        barPlot.barLineColor = .green
        barPlot.barColor = .yellow
        ...
        referenceLines.referenceLineLabelFont = .sfProDisplay(ofSize: 11, style: .regular)
        referenceLines.referenceLineColor = .blue
        referenceLines.referenceLinePosition = .left
        referenceLines.referenceLineLabelColor = .red
        
        referenceLines.dataPointLabelColor = UIColor.black.withAlphaComponent(0.3)
        
        // Setup the graph
//        graphView.backgroundFillColor = UIColor.colorFromHex(hexString: "#333333")
        graphView.backgroundFillColor = .mainDark
