...
struct OnboardingTitle {
    ...
    init(closeButton: Bool = true, firstTitle: String = "Upgrade to premium", secondTitle: String = "Start your 3-day free trial.", thirdTitle: String = "Then", thirdTitleIsHidden: Bool = false, gpsTitle: String = "GPS Speedometer", gpsSecondTitle: String = "Track your daily travelling activities with accurate speed data", tripTitle: String = "Trip History", tripSecondTitle: String = "Trip history is the automatic feature that will help you to save information within app", basicTitle: String = "Proceed with Basic", tryFreeTitle: String = "Start Monthly Plan", startYearlyFirstTitle: String = "Start Yearly Plan", startYearlySecondTitle: String = "a year", startYearlySecondTitleIsHidden: Bool = false, privacyEulaTitle: String = "This trial automatically renews into a paidsubscribtion and will continue to automatically renew until you cancel. Please see our") {
        self.ref = nil
        self.key = nil
